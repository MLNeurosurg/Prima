...
if __name__ == '__main__':
    ...
    config = {
        'clip_ckpt': 'tempmodelsavesite/scratch/checkpoints96bigvit/55.pt',
        'diagnosis_heads_json': 'configs/jsons/combbest927.json',
        'referral_heads_json': 'configs/jsons/combbest107referral.json',
        'priority_head_ckpt': 'tempmodelsavesite/104-priority-notord/bestauc2_priority.pt'
    }
    ...
    retrodataset = RachelDataset(
        datajson='datajson/glmv8-3.json',
        datarootdir='/scratch/tocho_root/tocho1/yiweilyu/glmv8-3/',
        is_train=False,
        vqvaename='TOKEN-MODEL-RESIZE-8-32-32-batch_permute-DATE-2024-04-02-0043AM',
    ...
    collator = collatevisualhash(
        copy.deepcopy(fullmodel.clipmodel.patchifier).cpu(),
        'cuda:0',
        True,
        True,
        puttodevice=True
