...
class MrDataset(ProtoDataset):
    """Dataset for MRI data with both visual and text components."""
        ...
        while len(out_series) == 0:
            ...
            for serie, _ in series:
                ...
                all_embs = torch.load(f"{serie_path}/stacked/stacked.pt",
                                    map_location='cpu')
                # this contains information about the tokens at different threshold to exclude
                # basically it excludes most of the background tokens
